        ...
        <div className="container">
          ...
          >
            ...
            <motion.div 
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
            >
              <h3>Face-to-Face Coaching</h3>
              <p>Traditional classroom setup with direct mentorship, intensive training, and guidance from top-performing engineers.</p>
            </motion.div>
            ...
            <motion.div 
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
            >
              <h3>Pre-board Examinations</h3>
              <p>Simulated board exams to evaluate your readiness, manage time pressure, and pinpoint weak subjects.</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
          ...
          >
            {[
              ...
              },
              {
                ...
                description: 'Experience the pressure of the actual board exam. Take timed mock exams with performance analytics. Stuck? Use the 50/50 Lifeline to eliminate options, or unlock the Smart Hint System. Every question comes with in-depth, step-by-step visual solutions.'
              },
              {
